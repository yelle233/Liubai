...
public final class RenderStatistics {
    ...
    private int valkyrienEntitiesBypassed, valkyrienBlockEntitiesBypassed, valkyrienParticlesBypassed;
    private final AtomicInteger valkyrienFlywheelBypassed = new AtomicInteger();
    ...
    public void valkyrienEntityBypassed() { valkyrienEntitiesBypassed++; }
    public void valkyrienBlockEntityBypassed() { valkyrienBlockEntitiesBypassed++; }
    public void valkyrienParticleBypassed() { valkyrienParticlesBypassed++; }
    public void valkyrienFlywheelBypassed() { valkyrienFlywheelBypassed.incrementAndGet(); }
    ...
    public void finishFrame(VisibilityService.Counts visibility, int liveParticles) {
        ...
        int safeFlywheel = valkyrienFlywheelBypassed.getAndSet(0);
        int[] values = {
                ...
                valkyrienEntitiesBypassed, valkyrienBlockEntitiesBypassed, valkyrienParticlesBypassed, safeFlywheel
        };
        ...
        valkyrienEntitiesBypassed = valkyrienBlockEntitiesBypassed = valkyrienParticlesBypassed = 0;
    }
    ...
    public Snapshot snapshot() {
        return new Snapshot(rate.entitiesTested, rate.entitiesSkipped, rate.entitiesOccluded, rate.entitiesTooSmall,
                ...
                rate.valkyrienEntitiesBypassed, rate.valkyrienBlockEntitiesBypassed,
                rate.valkyrienParticlesBypassed, rate.valkyrienFlywheelBypassed,
    ...
    private record Rate(int entitiesTested, int entitiesSkipped, int entitiesOccluded, int entitiesTooSmall,
                        ...
                        int valkyrienEntitiesBypassed, int valkyrienBlockEntitiesBypassed,
                        int valkyrienParticlesBypassed, int valkyrienFlywheelBypassed) {
