...
/** Reflection-isolated bridge to the public Valkyrien Skies ship API. */
public final class ValkyrienCompatibility {
    ...
    /** Refreshes state for particle hooks, which do not expose an owning ship. */
    ...
    public static boolean contains(Entity entity) {
        ...
        try {
            ...
            return (Object) blockLookup.invokeExact((Level) entity.level(), entity.blockPosition()) != null;
        } catch (Throwable error) {
            disableAfterFailure(error);
            return false;
        }
